...
type ipProvider struct {
	manager     eventEntities.IpInfoManager
	apiProvider eventEntities.IpInfoProvider
}
...
func NewAggregatedIpProvider(manager eventEntities.IpInfoManager) eventEntities.IpInfoProvider {
	return &ipProvider{
		manager:     manager,
